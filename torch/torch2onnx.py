...
def convert_onnx(net, path_module, output, opset=11, simplify=False):
    ...
    input_name = 'input'
    output_name = 'output'
    torch.onnx.export(net, img, output, keep_initializers_as_inputs=False, verbose=False, opset_version=opset,input_names = [input_name],output_names = [output_name],dynamic_axes= {
...
if __name__ == '__main__':
    ...
    convert_onnx(backbone_onnx, input_file, output_file, simplify=True)
